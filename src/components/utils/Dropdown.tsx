      ...
      <div className=" dropdown-menu hidden">
        {titleUl ? (
          <div className="divide media">
            <ul
              onClick={() => handleShowli()}
              className={showli ? "show title-ul" : "title-ul"}
              aria-label={titleUl[0]}
            >
            ...
            <ul
              className={showli1 ? "show title-ul" : "title-ul"}
              onClick={() => handleShowli1()}
              aria-label={titleUl[1]}
            >
          ...
          <ul>
            {link.map((link, i /* if dont have columns only cicle links */) => (
              <li key={link + i}>
                <Link className="dropdown-item" to={`/${link.toLowerCase()}`}>
                  {link}
                </Link>
              </li>
            ))}
